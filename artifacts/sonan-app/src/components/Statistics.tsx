  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="p-6 rounded-lg bg-gradient-to-r from-purple-900/40 to-indigo-900/30 border border-purple-500/30"
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-2xl font-bold text-purple-300">2500 XP</span>
        </div>
        ...
        <p className="text-sm text-purple-200/50 mt-2">625 / 1000 نقطة إلى المستوى التالي</p>
      </motion.div>
        ...
        <div className="grid grid-cols-3 gap-3">
          {data.achievements.map((achievement, idx) => (
            <motion.div
              ...
              className="p-3 rounded-lg bg-amber-900/30 border border-amber-500/30 text-center hover:border-amber-400/60 transition-colors cursor-pointer"
            >
              <span className="text-2xl mb-2 block">🏆</span>
              <p className="text-xs font-medium text-amber-300 truncate">{achievement}</p>
            </motion.div>
          ))}
          <div className="p-3 rounded-lg bg-amber-900/10 border border-dashed border-amber-500/20 text-center opacity-50">
            <span className="text-2xl mb-2 block">🔒</span>
            <p className="text-xs text-amber-300/50">قادم</p>
          </div>
        </div>
      </motion.div>
    </div>
